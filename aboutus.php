...
echo "<p id='boldHeader'>SMART SECURITY</P>";
echo "Smart-home monitoring products mean you can set up cameras to check on your home, even if you’re in another
country.<br>";
echo "You can either watch a live stream through your phone or tablet, or just get alerts when the motion sensor is
triggered.<br>";

echo "<p id='boldHeader'>SMART ENERGY</P>";
echo "Smart thermostat systems let you turn it off instantly from your phone – no matter where you are – or you can tell them<br>";
...
echo "<p id='boldHeader'>SMART SPEAKERS</P>";
echo "We’ve all got too much to do.<br>";
...
echo "<p id='boldHeader'>Whatever smart tech you are after, homteq has it on offer!</p>";
